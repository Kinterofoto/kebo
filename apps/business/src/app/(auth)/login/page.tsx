...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-svh bg-black">
      {/* Full-screen shell */}
      <div className="relative flex w-full min-h-svh flex-col items-center justify-center px-6 py-12 sm:px-12">
        <div className="w-full max-w-sm">
          {/* Logo */}
          <div className="flex justify-center mb-8">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-kebo-500 text-white font-bold text-xl">
              K
            </div>
          </div>
