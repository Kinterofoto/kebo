    ...
    <div className="space-y-6 pt-4">
      <div>
        ...
        <p className="text-muted-foreground">
          Bienvenido a Kebo Business. Gestiona las finanzas de tu empresa.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <CardDescription>Facturas este mes</CardDescription>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">0</div>
            <CardDescription>Entradas contables</CardDescription>
          </CardContent>
        </Card>
